...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadFoods(): Promise<void> {
      const aFoods = await api.get('/foods');

      setFoods(aFoods.data);
    }
  ...
  async function handleDeleteFood(id: number): Promise<void> {
    ...
    const newFoods = [...foods];
    const findIndex = newFoods.findIndex(findFood => findFood.id === id);

    delete newFoods[findIndex];
